...
import 'package:brightstar_delivery/job_history_detail.dart';
...
class CommissionHistoryScreen extends StatefulWidget {
  final Driver driver;
  const CommissionHistoryScreen({Key? key, required this.driver}) : super(key: key);

  @override
  _CommissionHistoryScreenState createState() => _CommissionHistoryScreenState();
}
...
class _CommissionHistoryScreenState extends State<CommissionHistoryScreen> {
  ...
  Widget build (BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: WillPopScope(
        ...
        child: Scaffold(
          key: _scaffoldKey,
          drawer: kDrawer(screen: '3', driver: widget.driver,),
          body: SafeArea(
                ...
                */
                ...
                SliverList(delegate: SliverChildBuilderDelegate(
                  ...
                  (context, i) {
                    ...
                    switch(histories[i].shipment_status) {
                      case "1":
                    ...
                    : GestureDetector(
                      onTap: () {
                        //showOrderDetails(context, order[i]);
                        Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => CommissionHistoryDetailScreen(driver: widget.driver, job_id: histories[i].job_id)));
                      },
                      child: Container(
                        padding: EdgeInsets.only(left: 10, right: 10),
                        child: Stack(
                                            ...
                                            TableCell(
                                              child: Container(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    Text(
                                                      "RM ${histories[i].driver_commission}",
                                                      style: TextStyle(
                                                        fontWeight: FontWeight.bold,
                                                        fontFamily: FitnessAppTheme.fontName,
                                                        fontSize: 16,
          ...
          bottomNavigationBar: kBottomAppBar(screen: "3", driver: widget.driver,)
        )
      )
    );
  }
  ...
  void loadHistories() {
    String url = "${util.baseUrl()}app/loadAllCommissionHistory";
          ...
          for (int i = 0; i < data.length; i++) {
            setState(() {
              histories.add(Job(
                ...
                driver_commission: data[i]['driver_commission'] ?? "",
