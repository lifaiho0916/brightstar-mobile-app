...
class CommissionHistoryDetailScreen extends StatefulWidget {
  final Driver driver;
  String job_id;
  CommissionHistoryDetailScreen({Key? key, required this.driver, required this.job_id}) : super(key: key);

  @override
  _CommissionHistoryDetailScreenState createState() => _CommissionHistoryDetailScreenState();
}

class _CommissionHistoryDetailScreenState extends State<CommissionHistoryDetailScreen> {
              ...
              SliverAppBar(
                ...
                leading: Builder(builder: (context) => // Ensure Scaffold is in context
                  IconButton(
                    ...
                    onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => CommissionHistoryScreen(driver: widget.driver)))
                  ),
                ),
                                    ...
                                    pickup_pictures.length, (index) {  
                                      return GestureDetector(
                                        child: Center(  
                                          ...
                                          //FadeInImage(image: NetworkImage(util.baseUrl() + util.shipmentPicUrl() + pickup_pictures[index]), placeholder: AssetImage("assets/images/corrupt-file.png"))
                                        ),
                                        onTap: () {
  ...
  void loadSingleShipment() {
    String url = "${util.baseUrl()}app/loadSingleCommissionHistory";
    ...
    http.post(Uri.parse(url), body: {
        ...
        if (util.isJson(res.body)) {
          print(res.body);
          List data = json.decode(res.body)['commission'];
                ...
                GestureDetector(
                  ...
                  onTap: () async {
                    if (pictures.isEmpty || quantityController.text.isEmpty) {
                      ...
                      String url = util.baseUrl() + "shipment.php";
  ...
  void assignDeliveryPartner(String driver_id) {
    String loginUrl = "${util.baseUrl()}shipment.php";
