...
class JobDetailScreen extends StatefulWidget {
  final Driver driver;
  String job_id;
  JobDetailScreen({Key? key, required this.driver, required this.job_id}) : super(key: key);
              ...
              SliverAppBar(
                ...
                leading: Builder(builder: (context) => // Ensure Scaffold is in context
                  IconButton(
                    ...
                    onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => MainScreen(driver: widget.driver)))
                  ),
                ),
