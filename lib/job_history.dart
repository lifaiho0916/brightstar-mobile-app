...
class JobHistoryScreen extends StatefulWidget {
  final Driver driver;
  const JobHistoryScreen({Key? key, required this.driver}) : super(key: key);
...
class _JobHistoryScreenState extends State<JobHistoryScreen> {
  ...
  Widget build (BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: WillPopScope(
        ...
        child: Scaffold(
          key: _scaffoldKey,
          drawer: kDrawer(screen: '2', driver: widget.driver,),
          body: SafeArea(
                ...
                SliverList(delegate: SliverChildBuilderDelegate(
                  ...
                  (context, i) {
                    ...
                    : GestureDetector(
                      onTap: () {
                        //showOrderDetails(context, order[i]);
                        Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => JobHistoryDetailScreen(driver: widget.driver, job_id: histories[i].job_id)));
                      },
                      child: Container(
                        padding: EdgeInsets.only(left: 10, right: 10),
                        child: Stack(
          ...
          bottomNavigationBar: kBottomAppBar(screen: "2", driver: widget.driver,)
        )
      )
    );
  }
  ...
  void loadHistories() {
    String loginUrl = "${util.baseUrl()}app/loadAllShipmentHistory";
